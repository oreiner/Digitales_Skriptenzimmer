                ...
                <ul>
                    <li data-transition="boxfade" data-title="Slide Title" data-param1="Additional Text" data-thumb="images/index/slider-01.jpg">
                        ...
                        <div class="tp-caption lfb tp-resizeme header-btn"
                             ...
                             style="z-index: 8;"><a href="#Anleitung Protokolle" class="el-btn-regular slider-btn-left">Anleitung Protokolle</a> <?php if(auth()->guard()->guest()): ?> <a href="#freischaltung" class="el-btn-regular">Anleitung Freischaltung</a> <?php endif; ?>
                        </div>
                    </li>
            ...
            <div class="row sider-btm-row-inner">
                ...
                <div class="col-sm-4 content_body slide_cont_box_03">
                    <div class="slider-btm-box btm-item_03">
                        ...
                        <a href="<?php echo e(url('faq')); ?>">Zu den FAQ<i class="fa fa-long-arrow-right slider-b-btn-icon"></i></a>
                  </div>
                </div>
...
Also, los geht's!</p>
                    ...
                    <a href="<?php echo e(url('faq')); ?>" class="read_more-btn fa fa-long-arrow-right">lese mehr</a>
                </div><!-- Ends: . -->

                <div class="col-sm-6 welcome-img">				<?php if(auth()->guard()->guest()): ?>					<img src="images/index/welcome.jpg" alt="" class="img-responsive">				<?php else: ?>
                     <img src="images/index/trio.jpg" alt="" class="img-responsive">	 <?php endif; ?>
				</div><!-- Ends: . -->
            </div>
        </div>
    </section><!-- Ends: . -->
            ...
            <div class="row courses-r-margin-bottom">
                <div class="col-sm-4 single-courses-box">
                    <div class="single-courses">
                        <figure>
                            ...
                            <figcaption>
                                <div><a href="<?php echo e(config('app.shop')); ?>" target='_blank' class="read_more-btn">Kauf bei uns im Skriptenzimmer</a></div>
                            </figcaption>
                        </figure>
                        <div class="courses-content-box">
                            <div class="courses-content">
                                <h3><a href="<?php echo e(config('app.shop')); ?>" target='_blank' >Kittel</a></h3>
				...
				<div class="col-sm-4 single-courses-box">
                    <div class="single-courses">
                        ...
                        <div class="courses-content-box">
                            <div class="courses-content">
                                <h3><a href="<?php echo e(config('app.shop')); ?>" target='_blank' >Reflexhammer</a></h3>
                                <!--<div class="rank-icons">
                                    <ul class="list-unstyled">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                ...
                <div class="col-sm-4 single-courses-box">
                    <div class="single-courses">
                        ...
                        <div class="courses-content-box">
                            <div class="courses-content">
                                <h3><a href="<?php echo e(config('app.shop')); ?>" target='_blank'>Stethoskope</a></h3>
                                <!--<div class="rank-icons">
                                    <ul class="list-unstyled">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
            ...
            <div class="row courses-r-margin-bottom">
                <div class="col-sm-4 single-courses-box">
                    <div class="single-courses">
                        ...
                        <div class="courses-content-box">
                            <div class="courses-content">
                                <h3><a href="<?php echo e(config('app.shop')); ?>" target='_blank'>Handschuhe S,M,L</a></h3>
                                <!--<div class="rank-icons">
                                    <ul class="list-unstyled">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                ...
                <div class="col-sm-4 single-courses-box">
                    <div class="single-courses">
                        ...
                        <div class="courses-content-box">
                            <div class="courses-content">
                                <h3><a href="<?php echo e(config('app.shop')); ?>" target='_blank'>Präparierset</a></h3>
                                <!--<div class="rank-icons">
                                    <ul class="list-unstyled">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                ...
                <div class="col-sm-4 single-courses-box">
                    <div class="single-courses">
                        ...
                        <div class="courses-content-box">
                            <div class="courses-content">
                                <h3><a href="<?php echo e(config('app.shop')); ?>" target='_blank' >Diagnostikleuchte</a></h3>
                                <!--<div class="rank-icons">
                                    <ul class="list-unstyled">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                ...
                <div class="col-12 col-offset-0 col-sm-5 col-sm-offset-0 counter-text-bottom">
                    <div class="counter-text-box  hidden-xs">
                        ...
                        <div class="counter-btn">
                            <a href="<?php echo e(config('app.wpb')); ?>">Direktzugang zum WPB-Gutachter</a>
                        </div>
                    </div>

					<div class="counter-text-box visible-xs">
						<div class="counter-btn">
								<a href="<?php echo e(config('app.wpb')); ?>">WPB-Gutachter</a>
						</div>
					</div>
				</div>
            </div>
