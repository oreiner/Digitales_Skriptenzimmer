                ...
                <ul>
                    <li data-transition="boxfade" data-title="Slide Title" data-param1="Additional Text" data-thumb="images/index/slider-01.jpg">
                        ...
                        <div class="tp-caption sfr font-extra-bold tp-resizeme letter-space-4 header-1 title-line-2"
                             ...
                             style="z-index: 6; font-size:60px; color:#fff; font-family: 'Montserrat', sans-serif;, serif; white-space: nowrap;font-weight:700;">Das Nächste Protokoll runterladen 
                        </div>
            ...
            <div class="row sider-btm-row-inner">
                ...
                <div class="col-sm-4 content_body slide_cont_box_02">
                    <div class="slider-btm-box btm-item_02">
                        ...
                        @guest
                        <h3>Andere Kollaboration</h3>
                        <p>Preis der Lehre</p>
                        <a href="#PDL">Lese mehr<i class="fa fa-long-arrow-right slider-b-btn-icon"></i></a>
						<p>WPB-Gutachter</p>
                        <a href="#WPB">Lese mehr<i class="fa fa-long-arrow-right slider-b-btn-icon"></i></a>
						@else
                        <h3>Skripte</h3>
                        <p>Skripte für dein Semester herunterladen. Immer greifbereit.</p>
                        <a href="/download">lese mehr<i class="fa fa-long-arrow-right slider-b-btn-icon"></i></a>
						@endguest
                    </div>
                </div>
                ...
                <div class="col-sm-4 content_body slide_cont_box_03">
                    <div class="slider-btm-box btm-item_03">
                        ...
                        <a href="#Angebot">Schau an<i class="fa fa-long-arrow-right slider-b-btn-icon"></i></a>
                    </div>
                </div>
        ...
        <div class="container" id="Anleitung Protokolle">
            <div class="row">
                <div class="col-sm-6 Welcome-area-text">
                    ...
                    <p>Wie das Kittelautomat funktioniert, kennst du bereits.
Den ersten Kittel darfst du einfach ziehen. Wenn du einen neuen haben willst, müsst du erst deinen alten abgeben.
Und So ist das mit den Protokollen. Das erste kriegst du, für die nächste müsstest du deine absolvierte Prüfung protokollieren.

Das geht alles sehr einfach!
Mit mindestens einem Satz pro Prüfer bist schon fertig. 
Mit weniger als 2 Minuten Arbeit hast du deine Kommilitonen und dir selber eine große Hilfe geleistet!

Also, los geht's!</p>

                    <a href="/login" class="read_more-btn fa fa-long-arrow-right">read more</a>
                </div><!-- Ends: . -->
            ...
            <div class="row">
                <div class="col-sm-6 Ort-area-text">
					...
					<div class="row" id="freischaltung">
                        <div class="col-sm-12 section-header-box">
                            <div class="section-header section-header-l">
                                <h2>Wie schaltest du deinen Account frei</h2>
                            </div><!-- ends: .section-header -->
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row courses-r-margin-bottom">
                <div class="col-sm-4 single-courses-box">
                    <div class="single-courses">
                        <figure>
                            ...
                            <figcaption>
                                <div><a href="{{ config('app.shop') }}c48381" target='_blank' class="read_more-btn">Kauf bei uns im Skriptenzimmer</a></div>
                            </figcaption>
                        </figure>
                        <div class="courses-content-box">
                            <div class="courses-content">
                                <h3><a href="{{ config('app.shop') }}c48381" target='_blank' >Kittel</a></h3>
                ...
                <div class="col-sm-4 single-courses-box">
                    <div class="single-courses">
                        <figure>
                            <div class="figure-img"><img src="images/skriptenzimmer/stethoscope.png" alt="" class="img-responsive"></div>
                            <figcaption>
                                <div><a href="{{ config('app.shop') }}" target='_blank' class="read_more-btn">Kauf bei uns im Skriptenzimmer</a></div>
                            </figcaption>
                        </figure>
    ...
    <section class="video-main-area video" id="PDL">
        <div class="container">
            ...
            !-->
                ...
                <div class="video-content center-block">
                    <iframe class="center-block" src="https://www.youtube.com/embed/j08SB1i1Grw" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" width="923" height="519" frameborder="0"></iframe>   
                </div>
				<!-- ends: .section-header -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 counters-item">
                            <div class="section counter-box">
                                ...
                                <div class="project-count counter"><?php echo $stats[0]; ?></div>
                        ...
                        <div class="col-sm-6 counters-item">
                            <div class="section counter-box">
                                ...
                                <div class="project-count counter"><?php echo $stats[1]; ?></div>
                        ...
                        <div class="col-sm-6 counters-item">
                            <div class="section counter-box">
                                ...
                                <div class="project-count counter"><?php echo $stats[2]; ?></div>
                ...
                <div class="col-sm-5 col-sm-offset-0 counter-text-bottom">
                    <div class="counter-text-box">
                        <div class="counter-text">
                            ...
                            <p>Es werden viele Wahlpflichtblöcke angeboten. Verschaffe dir ein Überblick! Hier kannst du Bewertungen durch deine Kommilitonen lesen und deine eigene Evaluationen abgegben.</p>
                        </div>

                        <div class="counter-btn">
                            <a href="http://www.wpbgutachter.xyz">geh auf WPB-Gutachter jetzt</a>
                        </div>
                    </div>
                </div>
