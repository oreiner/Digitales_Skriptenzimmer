...
<head>
    ...
    <meta name="description" content="Digitales Skriptenzimmer Koeln">
                 ...
                 <div class="row">
                     <div class="col-md-12">
                         <div class="intro-text ">
                             <h1>Profil</h1>
                             <p><span><a href="#">Startseite <i class='fa fa-angle-right'></i></a></span><span class="b-active"> Profil</span></p>
                         </div>
                     </div>
                 </div><!-- /.row -->
             </div><!-- /.container -->
