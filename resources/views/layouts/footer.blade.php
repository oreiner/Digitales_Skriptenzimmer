        ...
        <div class="row">
            <div class=" col-sm-12 footer-content-box">
                ...
                <div class="col-sm-2">
                    <h3>Links</h3>
                    <ul class="list-unstyled">
                        <li><a href="{{url('login')}}"><span><i class="fa fa-long-arrow-right footer-icon"></i></span>Anmeldung</a></li>
                        <li><a href="{{url('register')}}"><span><i class="fa fa-long-arrow-right footer-icon"></i></span>Registrierung</a></li>
                        <li><a href="{{url('mailpdf')}}"><span><i class="fa fa-long-arrow-right footer-icon"></i></span>Protokolle</a></li>
                        <li><a href="{{url('download')}}"><span><i class="fa fa-long-arrow-right footer-icon"></i></span>Skripte</a></li>
                        <li><a href="{{url('terms')}}"><span><i class="fa fa-long-arrow-right footer-icon"></i></span>AGB</a></li>
                    </ul>
                </div>
