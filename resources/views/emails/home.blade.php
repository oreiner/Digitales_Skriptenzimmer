        ...
        <div class="container" id="Anleitung Protokolle">
            <div class="row">
                <div class="col-sm-6 Welcome-area-text">
                    ...
                    <p>Wie der Kittelautomat funktioniert kennst du bereits.
Den ersten Kittel darfst du einfach ziehen. Wenn du einen neuen haben willst, musst du erst deinen alten abgeben.
Und so ist das auch mit den Protokollen. Das erste bekommst du vorgestreckt, für das nächste müsstest du deine absolvierte Prüfung protokollieren und einreichen.
Also, los geht's!</p>
            ...
            <div class="row">		
                ...
                <div class="col-12 col-offset-0 col-sm-5 col-sm-offset-0 counter-text-bottom">
					...
					<div class="counter-text-box visible-xs">
						<div class="counter-btn">
								<a href="http://www.wpbgutachter.xyz">WPB-Gutachter</a>
						</div>
					</div>
				</div>
            </div>
